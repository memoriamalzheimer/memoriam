...
selectDificuldade.addEventListener('change', () => {
    startGame(selectDificuldade.value);
});
...
window.onload = () => {
    ...
    const fecharInicioBtn = document.getElementById("fecharInicio");
    const abrirInstrucoesBtn = document.getElementById("abrirInstrucoes");
    const popupInstrucoes = document.getElementById("popupInstrucoes");
    const fecharPopupBtn = document.getElementById("fecharPopup");

    popupInicio.style.display = "flex";

    fecharInicioBtn.onclick = () => {
        popupInicio.style.display = "none";
    };

    abrirInstrucoesBtn.onclick = () => {
        popupInstrucoes.style.display = "flex";
    };

    fecharPopupBtn.onclick = () => {
        popupInstrucoes.style.display = "none";
    };
};
